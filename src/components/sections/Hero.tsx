        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-0 items-center min-h-[100dvh] lg:min-h-0">
          ...
          >
            <motion.div variants={itemVariants}>
              <SectionLabel>Преміальне будівництво</SectionLabel>
            </motion.div>
            ...
            <div className="overflow-hidden">
              ...
              >
                Будуємо
                <br />
                <span className="text-gold">на десятиліття</span>
              </motion.h1>
            </div>
            ...
            >
              MetaDim зводить об&apos;єкти, що стоять вічно. Від фундаменту до
              оздоблення — власні технології, власна техніка, фіксована ціна.
            </motion.p>
