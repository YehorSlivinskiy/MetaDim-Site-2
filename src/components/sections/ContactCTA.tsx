...
const contactItems = [
  { Icon: MapPin, label: "Адреса", value: "м. Київ, вул. Хрещатик, 22, оф. 14" },
  { Icon: Phone, label: "Телефон", value: "+380 44 247 18 39" },
  { Icon: EnvelopeSimple, label: "Email", value: "info@metadim.ua" },
